...
{
  RCL_CHECK_ARGUMENT_FOR_NULL(parameter1, false);
  RCL_CHECK_ARGUMENT_FOR_NULL(parameter2, false);
...
{
  RCL_CHECK_ARGUMENT_FOR_NULL(dst, false);
  RCL_CHECK_ARGUMENT_FOR_NULL(src, false);

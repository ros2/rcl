...
typedef atomic_uint_least64_t rcl_atomic_context_instance_id_t;
...
typedef struct rcl_context_t {
  ...
  /// Private instance ID for this context.
  /**
   * A value of `0` indicates that it is either invalid or zero-initialized.
   *
   * Accessing the instance id should still be done using the function
   ...
   */
  rcl_atomic_context_instance_id_t do_not_access_this_directly__instance_id_;
} rcl_context_t;

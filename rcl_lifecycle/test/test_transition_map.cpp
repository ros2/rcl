...
TEST_F(TestTransitionMap, initialized) {
  ...
  rcl_lifecycle_state_t state0 = {const_cast<char *>("my_state"), 0, NULL, NULL, 0};
  ...
  rcl_lifecycle_state_t state1 = {const_cast<char *>("my_state"), 1, NULL, NULL, 0};
  ...
  rcl_lifecycle_transition_t transition01 = {const_cast<char *>("from0to1"), 0,
